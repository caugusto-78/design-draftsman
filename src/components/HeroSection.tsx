  ...
  return (
    <div className="bg-gray-100 rounded-lg p-6 lg:p-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[400px]">
        ...
        <div className="bg-gray-300 rounded-lg p-6 space-y-6">
        ...
        <div className="space-y-4 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Button 
              size="lg" 
              className="h-auto p-6 bg-foreground text-background hover:bg-foreground/90 flex-col items-start text-left space-y-2"
            ...
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm opacity-90 truncate">Comece a criar o seu primeiro QR Code</div>
                </div>
              </div>
            </Button>
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="h-auto p-6 border-foreground bg-transparent hover:bg-muted/50 flex-col items-start text-left space-y-2"
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-lg text-foreground">Novo Workspace</div>
                  <div className="text-sm text-muted-foreground truncate">Organize os seus projetos por categorias</div>
                </div>
              </div>
            </Button>
          </div>
