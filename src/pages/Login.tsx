            ...
            <CardContent className="space-y-6">
               ...
               <div className="grid grid-cols-2 gap-4">
                 <Button variant="outline" className="w-full">
                  ...
                  <Button variant="outline" className="w-full">
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24">
                      <path fill="currentColor" d="M0 0h11.378v11.378H0z"/>
                      <path fill="currentColor" d="M12.622 0H24v11.378H12.622z"/>
                      <path fill="currentColor" d="M0 12.622h11.378V24H0z"/>
                      <path fill="currentColor" d="M12.622 12.622H24V24H12.622z"/>
                    </svg>
                    Microsoft
                  </Button>
               </div>
